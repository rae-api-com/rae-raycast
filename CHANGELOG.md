...
- Bumped dependencies and resolved security advisories (high-severity issues in `@babel/plugin-transform-modules-systemjs` and `fast-uri`)
- Upgraded Jest to 30 and TypeScript to 6
